...
export class AboutService {
  ...
  getEnglishContent() {
    const about: About = {
      whyChooseTawsileHeader: 'Why choose Tawselah',
      ...
      // tslint:disable-next-line: max-line-length
      rideCheckDesc: 'Ride Check is an additional safety feature that will reach out to check on you if there is an unexpected long stop during your travel with Tawselah. We will offer support and tools to get you help if anything happens during your ride.',

      opinionTitle: 'Your opinions matter',
      // tslint:disable-next-line: max-line-length
      opinionDesc: 'we take all reviews very seriously and will investigate any negative reviews. Our community is our top priority and we will remove any driver that does not meet the Tawselah standard of safety and service.'
    };
  ...
  getArabicContent() {
    const about: About = {
      ...
      // tslint:disable-next-line: max-line-length
      aboutTawsilaDesc: 'نحن شركة جديدة تقدم رحلة أكثر أمانًا وموثوقية يمكنك الحصول عليها.  أي وجهة في متناول يدك عندما تختار Tawselah ، وكالعادة ، نحن على بعد نقرة واحدة فقط!',
      ...
      // tslint:disable-next-line: max-line-length
      safetyDesc: 'لضمان سلامة الركاب والسائقين لدينا ، قامت Tawselah بتشغيل نظام GPS في المتابعة التحركات من البداية إلى النهاية بالإضافة إلى مشاركة الموقع حتى تتمكن عائلتك أو أصدقائك من تتبع رحلتك أيضًا.',
      rideCheckTitle: 'فحص الرحلة',
      // tslint:disable-next-line: max-line-length
      rideCheckDesc: 'Ride Check هي ميزة أمان إضافية ستصل إليك للتحقق مما إذا كان هناك توقف طويل غير متوقع أثناء سفرك مع Tawselah.  سنقدم لك الدعم والأدوات لمساعدتك إذا حدث أي شيء أثناء رحلتك.',
